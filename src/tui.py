...
class TUI:
    def __init__(self, usuario, user_manager, sales_manager, inventory_control, expenses_manager):
        ...
        self.barcode_reader = BarcodeReader()  # Inicialização do atributo barcode_reader
    ...
    def ver_todos_produtos(self):
        ...
        for produto in produtos:
            table.add_row(
                ...
                str(produto[6]), str(produto[7]), produto[8]
            )
        self.console.print(table)
    ...
    def cadastrar_produto(self):
        ...
        self.inventory_control.cadastrar_produto(nome, descricao, categoria, codigo_barras, fornecedor, preco, quantidade, local_armazenamento)
        self.console.print(f"Produto '{nome}' cadastrado com sucesso.")
        logging.info(f"Produto cadastrado: {nome}, Descrição: {descricao}, Categoria: {categoria}, Código de Barras: {codigo_barras}, Fornecedor: {fornecedor}, Preço: {preco}, Quantidade: {quantidade}, Local de Armazenamento: {local_armazenamento}")
    ...
    def ver_salarios(self):
        ...
        table = Table(show_header=True, header_style="bold magenta")
        table.add_column("ID", justify="center")
        table.add_column("Funcionário", justify="center")
        table.add_column("Valor", justify="center")
        table.add_column("Data", justify="center")
    ...
    def exibir_dashboard(self):
        ...
        table.add_column("Nome", justify="center")
        table.add_column("Categoria", justify="center")
        table.add_column("Preço de Custo", justify="center")
        table.add_column("Preço de Venda", justify="center")
        table.add_column("Quantidade", justify="center")
        for produto in produtos:
    ...
    def ver_atividades(self):
        ...
        table = Table(show_header=True, header_style="bold magenta")
        table.add_column("ID", justify="center")
        table.add_column("Usuário", justify="center")
    ...
    def ver_historico_compras(self):
        ...
        table = Table(show_header=True, header_style="bold magenta")
        table.add_column("ID Venda", justify="center")
        table.add_column("ID Produto", justify="center")
        table.add_column("Quantidade", justify="center")
        table.add_column("Preço Total", justify="center")
        table.add_column("Forma de Pagamento", justify="center")
        table.add_column("Desconto", justify="center")
        table.add_column("Data", justify="center")
    ...
    def ver_horarios(self):
        ...
        table.add_column("Saída", justify="center")
    ...
    def ver_metas(self):
        ...
        table.add_column("ID", justify="center")
        table.add_column("Usuário", justify="center")
        table.add_column("Meta de Vendas", justify="center")
        for meta in metas:
